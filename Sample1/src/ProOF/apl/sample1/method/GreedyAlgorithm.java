...
public class GreedyAlgorithm extends Heuristic {
    ...
    private final Factory fBranchProblem;
    private final Factory fStop;
    public GreedyAlgorithm(Factory fBranchProblem, Factory fStop) {
        this.fBranchProblem = fBranchProblem;
        this.fStop = fStop;
    }
    ...
    public void services(LinkerApproaches link) throws Exception {
        problem = link.get(fBranchProblem, problem);
